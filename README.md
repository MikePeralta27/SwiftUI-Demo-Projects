...
| [**FaceRecall**](FaceRecall/) | Conference contacts: **PhotosPicker** import, immediate naming alert, SwiftData persistence with external image storage, sorted list, detail view, and swipe delete. |
