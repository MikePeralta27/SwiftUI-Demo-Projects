...
| [**FriendFace**](FriendFace/) | Social directory: fetch HWS sample users once, persist with **SwiftData**, sorted list, detail with profile and friends. |
